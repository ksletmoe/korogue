...
fun haveCharacterData(expectedCharacterData: AsciiCharacterData) = object : Matcher<AsciiCharacterData> {
    ...
    override fun test(value: AsciiCharacterData): MatcherResult {
        val matched = value.character == expectedCharacterData.character
