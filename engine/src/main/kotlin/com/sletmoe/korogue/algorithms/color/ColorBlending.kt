...
object ColorBlending {
    ...
    fun screen(
        a: Color,
        b: Color,
    ): Color = screen(a.toNormalizedRgb(), b.toNormalizedRgb()).toColor()
    ...
    fun screen(
        a: Double,
        b: Double,
    ): Double = 1.0 - (1.0 - a) * (1.0 - b)

    fun softLight(
        a: Color,
        b: Color,
    ): Color = softLight(a.toNormalizedRgb(), b.toNormalizedRgb()).toColor()
